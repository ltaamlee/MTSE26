...
const Home = () => {
  ...
  const loadMockData = () => {
    const mockCategories = [
      { _id: '1', name: 'Bút Thư Pháp', slug: 'but-thu-phap', image: 'https://images.unsplash.com/photo-1456735190827-d1262f71b8a3?w=400' },
      { _id: '2', name: 'Mực Thư Pháp', slug: 'muc-thu-phap', image: 'https://images.unsplash.com/photo-1513161455079-7dc1de15ef3e?w=400' },
      { _id: '3', name: 'Giấy Thư Pháp', slug: 'giay-thu-phap', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=400' },
      { _id: '4', name: 'Nghiên Mực', slug: 'nghien-muc', image: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=400' }
    ];
    ...
    setNewestProducts(mockProducts.filter(p => p.isNew));
    setBestSellers(mockProducts.sort((a, b) => b.sold - a.sold));
  };
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-500 mt-2">Những sản phẩm được tin dùng nhất</p>
            </div>
            <Link to="/products?filter=bestseller" className="btn-outline hidden md:inline-block">
              Xem tất cả
            </Link>
          </div>
          ...
          <div className="mt-8 text-center md:hidden">
            <Link to="/products?filter=bestseller" className="btn-outline">
              Xem tất cả
            </Link>
          </div>
        </div>
