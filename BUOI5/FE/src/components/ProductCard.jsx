      ...
      <div className="p-4">
        ...
        {showAddToCart && product.stock > 0 && (
          <button
            ...
            className="w-full mt-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white py-2 rounded-lg font-medium hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
          >
