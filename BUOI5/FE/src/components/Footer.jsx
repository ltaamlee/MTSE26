...
const Footer = () => {
  ...
  const categories = [
    { name: 'Bút Thư Pháp', slug: 'but-thu-phap' },
    { name: 'Mực Thư Pháp', slug: 'muc-thu-phap' },
    { name: 'Giấy Thư Pháp', slug: 'giay-thu-phap' },
    { name: 'Nghiên Mực', slug: 'nghien-muc' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-12 h-12 bg-linear-to-br from-primary-500 to-secondary-600 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">Văn phòng tứ bảo</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              Chuyên cung cấp các sản phẩm thư pháp cao cấp: bút, mực, giấy và nghiên mực 
              cho quý khách hàng có niềm đam mê với nghệ thuật thư pháp.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>contact@tubaothupham.vn</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} Minh Tâm Đường. Tất cả quyền được bảo lưu.
            </p>
