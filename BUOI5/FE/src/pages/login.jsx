      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-6">
            <div className="w-14 h-14 bg-gradient-to-br from-primary-600 to-secondary-700 rounded-full flex items-center justify-center">
        ...
        <p className="mt-6 text-center text-gray-500 text-sm">
          <Link to="/" className="hover:text-primary-600">← Quay lại trang chủ</Link>
        </p>
      </div>
    </div>
  );
